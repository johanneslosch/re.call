...
public class WebSockets  extends WebSocketServer {
    ...
    public void onClose(WebSocket conn, int code, String reason, boolean remote) {
        System.out.printf("closed %s with exit code %d additional info: %s%n", conn.getRemoteSocketAddress(), code, reason);
    }
    ...
    public void onError(WebSocket conn, Exception ex) {
        System.err.printf("an error occurred on connection %s:%s%n", conn.getRemoteSocketAddress(), ex);
    }
